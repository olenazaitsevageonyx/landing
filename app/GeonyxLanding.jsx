      ...
      <header className="gx-hero">
        <div className="gx-c gx-hero-grid">
          <div className="gx-rev gx-in">
            ...
            <p className="gx-lead">An independent U.S. firm that instruments how AI models recognize, recommend and cite entities across global and sovereign systems, and turns it into decisions you can act on.</p>
            ...
            <div className="gx-hero-actions">
              <button className="gx-btn" onClick={() => go('#cases')}>See what we deliver</button>
      ...
      <section className="gx-sec gx-sec-light" id="identity">
        <div className="gx-c">
          <div className="gx-sec-head gx-rev">
            ...
            <p className="gx-sub">Most tools tell you whether AI mentions you. We tell you why it chooses someone else. And we never execute the work we recommend, which is what keeps the diagnosis honest.</p>
          </div>
      ...
      <section className="gx-sec" id="coverage">
        <div className="gx-c">
          <div className="gx-sec-head gx-rev">
            ...
            <div className="gx-rule" />
            <h2 className="gx-h2">Visibility in one region&rsquo;s models tells you nothing about another&rsquo;s.</h2>
            <p className="gx-sub">Each market runs on a different set of models, in a different language. We measure where your capital and customers actually are, including sovereign models on dedicated GPU that API-only tools cannot reach.</p>
          </div>
